      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-5 bg-white rounded-3xl border border-slate-200 shadow-xs">
          ...
          <div className="text-xs text-slate-500 mt-1">
            दर्ता भएका ग्राहकहरू (Registered buyers)
          </div>
        </div>
        ...
        <div className="lg:col-span-5 bg-white rounded-3xl border border-slate-200 shadow-xs p-5 space-y-4">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="group relative px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold flex items-center gap-1.5 transition-colors shadow-xs cursor-pointer"
            >
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto pb-1 scrollbar-none text-[11px] font-semibold">
            {['All', 'VIP Platinum', 'Gold', 'Silver', 'Bronze'].map((tier) => (
              <button
                key={tier}
